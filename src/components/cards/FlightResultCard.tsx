...
const FlightResultCard = ({
  ...
  return (
    <div className="bg-card rounded-xl border border-border p-4 md:p-6 shadow-sm hover:shadow-md transition-shadow duration-200">
          ...
          <div className="flex-1 flex flex-col items-center px-4">
            ...
            <div className="w-full relative">
              <div className="w-full h-0.5 bg-border rounded-full">
                ...
                {stops > 0 && (
                  <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-2 h-2 rounded-full bg-muted-foreground border-2 border-card"></div>
                )}
