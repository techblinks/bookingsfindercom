  ...
  return (
    <SectionContainer className="bg-background">
      ...
      <div className="max-w-3xl mx-auto">
        {/* Inline flight search form */}
        <div className="bg-card rounded-2xl border border-border p-4 md:p-6 shadow-sm mb-8">
          <ModernFlightSearch />
        </div>

        <div className="text-center">
          {/* Feature card with available badge */}
          <div className="relative inline-flex items-center gap-3 px-6 py-4 bg-background rounded-2xl border border-border shadow-card mb-4">
