...
const regionConfigs: Record<string, RegionConfig> = {
  AU: {
    ...
    popularRoutes: [
      ...
      { origin: "MEL", originName: "Melbourne", destination: "LAX", destinationName: "Los Angeles" },
      { origin: "SYD", originName: "Sydney", destination: "HKG", destinationName: "Hong Kong" },
    ],
  },
  IN: {
    defaultOrigin: "DEL",
    ...
    popularRoutes: [
      ...
      { origin: "CCU", originName: "Kolkata", destination: "DEL", destinationName: "Delhi" },
    ],
  },
  US: {
    defaultOrigin: "JFK",
    ...
    popularRoutes: [
      ...
      { origin: "ATL", originName: "Atlanta", destination: "JFK", destinationName: "New York" },
  ...
  GB: {
    ...
    popularRoutes: [
      ...
      { origin: "EDI", originName: "Edinburgh", destination: "LHR", destinationName: "London" },
      { origin: "LHR", originName: "London", destination: "FCO", destinationName: "Rome" },
      { origin: "LGW", originName: "London Gatwick", destination: "PMI", destinationName: "Palma" },
    ],
  },
  SG: {
    defaultOrigin: "SIN",
    ...
    popularRoutes: [
      ...
      { origin: "SIN", originName: "Singapore", destination: "CGK", destinationName: "Jakarta" },
      { origin: "SIN", originName: "Singapore", destination: "MNL", destinationName: "Manila" },
      { origin: "SIN", originName: "Singapore", destination: "ICN", destinationName: "Seoul" },
      { origin: "SIN", originName: "Singapore", destination: "TPE", destinationName: "Taipei" },
    ],
  },
  AE: {
    defaultOrigin: "DXB",
    ...
    popularRoutes: [
      ...
      { origin: "AUH", originName: "Abu Dhabi", destination: "LHR", destinationName: "London" },
      { origin: "DXB", originName: "Dubai", destination: "CDG", destinationName: "Paris" },
      { origin: "DXB", originName: "Dubai", destination: "JFK", destinationName: "New York" },
      { origin: "DXB", originName: "Dubai", destination: "SIN", destinationName: "Singapore" },
      { origin: "DXB", originName: "Dubai", destination: "CAI", destinationName: "Cairo" },
    ],
  },
};
...
const defaultConfig: RegionConfig = {
  ...
  popularRoutes: [
    ...
    { origin: "AMS", originName: "Amsterdam", destination: "CDG", destinationName: "Paris" },
  ],
};
