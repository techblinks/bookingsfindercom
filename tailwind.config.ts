  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        /* Things V2 (T3C): the mobile filter sheet has referenced
           `animate-slide-up` since before T3B, but the keyframes were never
           defined — the class resolved to nothing and the sheet appeared
           instantly. Design system §15.2 asks for a 200-300ms fade + slide. */
        "slide-up": {
